 ...
 * @LastEditors: lxw
 * @LastEditTime: 2020-06-04 12:14:39
 */
...
router.post('/add', (req, res, next) => {
    ...
    articleService.add(req.body).then((result) => {
...
router.post('/addMore', (req, res, next) => {
    ...
    articleService.addMany(list).then((result) => {
        res.status(200).json(result)
    }).catch((err) => {
        consoleLog(JSON.stringify(err), 'red')
        res.status(500).json(err)
...
router.get('/:id', (req, res, next) => {
    ...
    articleService.findById(req.params.id).then((result) => {
        res.status(200).json(result)
    }).catch((err) => {
        consoleLog(JSON.stringify(err), 'red')
        res.status(500).json(err)
...
router.patch('/findAll', (req, res, next) => {
    ...
    articleService.findAll(pageNum, pageSize).then((result) => {
        res.status(200).json(result)
    }).catch((err) => {
        consoleLog(JSON.stringify(err), 'red')
        res.status(500).json(err)
...
router.patch('/findValug', (req, res, next) => {
    ...
    articleService.fiindValug(strategyid,pageNum, pageSize).then((result) => {
        res.status(200).json(result)
    }).catch((err) => {
        consoleLog(JSON.stringify(err), 'red')
        res.status(500).json(err)
...
router.post('/findByIds', (req, res, next) => {
    ...
    articleService.findByIds(req.body.list, req.body.pageNum, req.body.pageSize).then((result) => {
        res.status(200).json(result)
    }).catch((err) => {
        consoleLog(JSON.stringify(err), 'red')
        res.status(500).json(err)
...
router.put('/:id', (req, res, next) => {
    ...
    articleService.updatById(req.params.id, req.body).then((result) => {
        res.status(200).json(result)
    }).catch((err) => {
        consoleLog(JSON.stringify(err), 'red')
        res.status(500).json(err)
...
router.delete('/:id', (req, res, next) => {
    consoleLog(`动态路由请求数据${JSON.stringify(req.params.id)}`, 'blue')
    articleService.deletById(req.params.id).then((result) => {
        res.status(200).json(result)
    }).catch((err) => {
        consoleLog(JSON.stringify(err), 'red')
        res.status(500).json(err)
