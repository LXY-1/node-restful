 ...
 * @LastEditors: lxw
 * @LastEditTime: 2020-06-04 10:50:12
 */
import MessageDao from '../dao/MessageDao';
import responResult from '../utils/responResult';

const messDao = new MessageDao()
...
class MessageService {
    ...
    addMany(list) {
        return new Promise((resolve, reject) => {
            messDao.inseratMany(list).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    findById(id) {
        ...
        return new Promise((resolve, reject) => {
            messDao.findOne(condtion).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    findAll(pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            messDao.findAllByPage(pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    * @msg: 
    * @param {type} | 权限字段 |treceiverType
    * @param {type} | 分页字段 | state
    * @return: 
    */
    fiindValug(receiverType, state, pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            messDao.findByVgue(condition, pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    findByIds(idlists, pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            messDao.findByIdArray(idlists, pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    updatById(id, updateObj) {
        ...
        return new Promise((resolve, reject) => {
            messDao.update(condtion, updateObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    deletById(id) {
        ...
        return new Promise((resolve, reject) => {
            messDao.remove(condtion).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
