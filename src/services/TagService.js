 ...
 * @LastEditors: lxw
 * @LastEditTime: 2020-06-03 11:27:57
 */
...
class TagsService {
    ...
    addMany(list) {
        return new Promise((resolve, reject) => {
            tagDao.inseratMany(list).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    findById(id) {
        ...
        return new Promise((resolve, reject) => {
            tagDao.findOne(condtion).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    findAll(pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            tagDao.findAllByPage(pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    */
    fiindValug(title, parenttitle, pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            tagDao.findByVgue(condition, pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    findByIds(idlists, pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            tagDao.findByIdArray(idlists, pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    updatById(id, updateObj) {
        ...
        return new Promise((resolve, reject) => {
            tagDao.update(condtion, updateObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    deletById(id) {
        ...
        return new Promise((resolve, reject) => {
            tagDao.remove(condtion).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
