...
class StrategyService {
    ...
    addMany(list) {
        return new Promise((resolve, reject) => {
            stDao.inseratMany(list).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    findById(id) {
        ...
        return new Promise((resolve, reject) => {
            stDao.findOne(condtion).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    findAll(pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            stDao.findAllByPage(pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    * @return: 
    */
    fiindValug(title, pendingState, pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            stDao.findByVgue(condition, pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    fiindValugByIdUseerId(puhlishid, pageNum, pageSize) {
   ...
   findByOrder( pageNum, pageSize) {
    ...
    return new Promise((resolve, reject) => {
        stDao.findAllByOrder(pageObj,'startnum',1).then((result) => {
            console.log(`请求成功${result}`)
            // 请求成功返回成功的json 状态码200
            responResult['SUCCESS'].data = result
            resolve(responResult['SUCCESS'])
    ...
    findByIds(idlists, pageNum, pageSize) {
        ...
        return new Promise((resolve, reject) => {
            stDao.findByIdArray(idlists, pageObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    updatById(id, updateObj) {
        ...
        return new Promise((resolve, reject) => {
            stDao.update(condtion, updateObj).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
    ...
    deletById(id) {
        ...
        return new Promise((resolve, reject) => {
            stDao.remove(condtion).then((result) => {
                console.log(`请求成功${result}`)
                // 请求成功返回成功的json 状态码200
                responResult['SUCCESS'].data = result
                resolve(responResult['SUCCESS'])
